...
metadata:
  short-description: Plan and write ISF shaders for Resolume Wire
---
...
- [Input Types & JSON Structure](references/inputs.md) - Complete INPUT definitions
- [ISF & GLSL Functions](references/functions.md) - IMG_PIXEL, IMG_NORM_PIXEL, etc.
- [Converting Shadertoy/GLSL to ISF](references/conversion.md) - Porting guide
...
3. Reference materials in `references/` provide syntax details
