...
metadata:
  short-description: Plan and write TouchDesigner GLSL shaders
---
...
[Pre-selected code patterns from references/glsl-reference.md that apply to this specific shader]
...
For TouchDesigner GLSL syntax, built-in variables, and common patterns, see [references/glsl-reference.md](references/glsl-reference.md).
...
3. Reference material in `references/glsl-reference.md` provides syntax details
