...
While not really documented for now, here are the diﬀerent functions availble in any shader that includes "MadNoise.glsl"

Note that in MadMapper, any shader can include the ﬁle by adding
