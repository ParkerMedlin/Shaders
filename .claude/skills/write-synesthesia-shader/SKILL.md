...
Synesthesia has extensive documentation in the reference directory:

- [Intro & Basics](reference/Intro.md) - Scene structure, coordinate systems
- [Audio Uniforms](reference/SSFAudioUniforms.md) - All audio-reactive uniforms
- [Built-in Functions](reference/SSFFunctions.md) - Math, noise, color, coordinate functions
- [Media Uniforms](reference/SSFMediaUniforms.md) - User media integration
- [JSON Configuration](reference/JSONConfig.md) - scene.json control definitions
- [JavaScript Scripting](reference/JavaScriptScripting.md) - Per-frame scripting
- [External Libraries](reference/ExternalLibraries.md) - lygia, hg_sdf
- [Best Practices](reference/BestPractices.md) - Performance and design guidelines
