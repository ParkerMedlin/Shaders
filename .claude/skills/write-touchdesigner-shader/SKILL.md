...
# Writing GLSL Shaders for TouchDesigner
...
See [TouchDesigner GLSL Reference](../../../markdown_exports/TouchDesignerGLSL.md) for complete documentation including:
- Texture info structures (`TDTexInfo`)
- Atomic counters
- Specialization constants
- POP attribute buffers
- 3D textures and 2D arrays
