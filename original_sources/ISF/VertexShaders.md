Vertex Shaders
Editing Vertex Shader in ISF EditorEditing Vertex Shader in the ISF Editor.
...
GLSL provides many built-in functions for working with angles and trigonometry, a list of which can be found in the ISF and GLSL Variables and Uniforms Reference Page for quick lookup.
...
Rotation in Fragment Shader.fs
